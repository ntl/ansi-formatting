...
context "Style" do
  context "Non-Strict Combination" do
    ...
    context "Codes Do Not Differ" do
      ...
      test "Does not combine the codes" do
        assert(style.code == style_1.code)
      end
    ...
    context "Reset Codes Do Not Differ" do
      ...
      test "Does not combine the reset codes" do
        assert(style.reset_code == style_1.reset_code)
      end
    end
  end
end
